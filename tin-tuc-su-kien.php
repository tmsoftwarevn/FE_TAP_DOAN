        ...
        <div class="smooth-scroll">
            <div class="container" id="news-page">
                ...
                <section class="banner-inner">
                    ...
                    <div class="bg-inner"><img src="/images/bg-truyenthong.jpg" data-src="/images/bg-truyenthong.jpg" alt="Truyền thông" class="lazy"></div>
                    ...
                    <div class="outer-nav release ani-item sub-ajax">
                        <div class="sub-nav">
                            <ul>
                                ...
                                <li><a class="sub-nav-a" data-name="news-342" href="/truyen-thong/image" aria-label="Hình ảnh">Albums</a>
                                    <div class="class-hidden link-change-url" data-title="Hình ảnh" data-description="SEN GROUP"
