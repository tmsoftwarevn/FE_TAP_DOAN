...
<body>
    <div id="render-styles"></div><noscript id="deferred-styles"><link rel="stylesheet" href="/catalog/view/css/app.css?ver=1.0.8"></noscript>
...
C57.9,89.7,53.8,90.3,49.6,90.3z"/></g></svg></div>
        <div class="navigation"><span></span>
            <nav class="main-menu">
                <ul>
                    <li class="nav-item"><a class="link-home link-load nav-item-a" href="/" data-name="home-page" aria-label="nav">Trang chủ</a>
                        <div class="class-hidden link-change-url" data-hrefen="/home-page.html" data-hrefvi="/trang-chu.html"
                            data-title="Trang chủ" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="/gioi-thieu.html" data-name="about-page" aria-label="nav">Giới thiệu</a>
                        <div class="class-hidden link-change-url" data-hrefen="/about-us.html" data-hrefvi="/gioi-thieu.html"
                            data-title="Giới thiệu" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="/linh-vuc-hoat-dong.html" data-name="business-page" aria-label="nav">Lĩnh vực hoạt động</a>
                        <div class="class-hidden link-change-url" data-hrefen="/business-sector.html"
                            data-hrefvi="/linh-vuc-hoat-dong.html" data-title="Lĩnh vực hoạt động" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="/cong-ty-thanh-vien.html" data-name="project-page" aria-label="nav">Công ty thành viên</a>
                        <div class="class-hidden link-change-url" data-hrefen="/members.html"
                            data-hrefvi="/cong-ty-thanh-vien.html" data-title="Công ty thành viên" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="/hoat-dong-tieu-bieu.html" data-name="activities-page" aria-label="nav">Hoạt động tiêu biểu</a>
                        <div class="class-hidden link-change-url" data-hrefen="/activities.html"
                            data-hrefvi="/hoat-dong-tieu-bieu.html" data-title="Hoạt động tiêu biểu" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="/phat-trien-nguon-nhan-luc.html" data-name="recruitment-page" aria-label="nav">Phát triển nguồn nhân lực</a>
                        <div class="class-hidden link-change-url" data-hrefen="/recruitment.html"
                            data-hrefvi="/phat-trien-nguon-nhan-luc.html" data-title="Phát triển nguồn nhân lực" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item current"><a class="link-load nav-item-a" href="/truyen-thong.html" data-name="news-page" aria-label="nav">Truyền thông</a>
                    ...
                    <li class="nav-item"><a class="link-load nav-item-a" href="/lien-he.html" data-name="contact-page" aria-label="nav">Liên hệ</a>
        ...
        <div class="right-header">
            ...
            <div class="language">
                <form id="change_lang" enctype="multipart/form-data" method="post" onsubmit="return false;">
                    <ul>
                        <li class="active"><button class="vi" aria-label="vi" onclick="onClick('vi','/truyen-thong.html');">tiếng việt</button></li>
                        <li><button class="en" aria-label="en" onclick="onClick('en','/media.html');">english</button></li>
                    </ul><input type="hidden" value="" name="language_code" id="language_code" aria-label="input"> <input id="changlanguage_redirect" type="hidden" value="/truyen-thong.html" name="redirect" aria-label="input"></form>
            </div>
        </div>
        <div class="social">
            <ul>
            ...
            <div class="container" id="news-page">
                ...
                <section class="section-outernav">
                    <div class="outer-nav release ani-item sub-ajax">
                        <div class="sub-nav">
                            <ul>
                                <li><a class="sub-nav-a current" data-name="news-373" href="/truyen-thong/tin-cong-ty.html" aria-label="TIN CÔNG TY">TIN CÔNG TY</a>
                                <div class="class-hidden link-change-url" data-title="Hình ảnh" data-description="SEN GROUP"
                                data-keyword="SEN GROUP" data-hrefen="/truyen-thong/tin-cong-ty.html" data-hrefvi="/truyen-thong/tin-cong-ty.html" aria-label="link-change-url"></div>
                                </li>
                                ...
                                <li><a class="sub-nav-a" data-name="news-342" href="/truyen-thong/hinh-anh.html" aria-label="Hình ảnh">Hình ảnh</a>
                                    <div class="class-hidden link-change-url" data-title="Hình ảnh" data-description="SEN GROUP"
                        ...
                        <div class="wheel-submit wheel-next"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill="currentColor" d="M5.5,2.7L10.9,8l-5.3,5.4l-0.7-0.7L9.4,8L4.8,3.4L5.5,2.7z"/></svg></div>
                        <div class="wheel-submit hide wheel-prev"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill="currentColor" d="M10.1,13.4L4.8,8l5.3-5.3l0.7,0.7L6.2,8l4.7,4.6L10.1,13.4z"/></svg></div>
                    </div>
                </section>
            ...
            <div class="wrap-register-form">
                <form id="register" name="register" method="post" onsubmit="return false;">
                    <div class="require-col color-blue">
                        ...
                        <div
                            class="wrap-view-details big-view"><button class="view-details dark" aria-label="submit" id="btn-register-submit" data-page="/thank-you-.html"><span class="small-logo-ico"><svg><use xlink:href="#ico-view-details-logo"></use></svg> <span class="rotate-logo"><svg><use xlink:href="#ico-view-details-rotate-send"></use></svg> </span></span> GỬI <svg class="viewdetails-svg"><use xlink:href="#arrow"></use></svg></button></div>
            </div>
            </form>
        </div>
...
c3.7-3.7,9.6-3.7,13.3,0s3.7,9.5,0,13.2s-9.6,3.7-13.3,0S13.4,19,17.1,15.5z"/></svg></div>
                    <div class="input-text"><span class="holder">Tìm kiếm ...</span><input type="text" id="quicksearch" name="quicksearch" data-default="Tìm kiếm ..." value="" aria-label="field-search">
                        ...
                        </div><button class="display-none link-search-load-typing" data-href="/tim-kiem.html" aria-label="search"></button></div>
                    <div class="close-search"></div><input type="hidden" id="defaultvalue" name="defaultvalue" value="Tìm kiếm ..." aria-label="default value"> <input type="hidden" id="errorsearchcode" name="errorsearch" value="Từ khóa không được dưới 3 kí tự, vui lòng nhập lại từ khóa tìm kiếm!"
                        aria-label="errorsearch"> <input type="hidden" id="href_search" name="href_search" value="/tim-kiem.html" aria-label="href search"></form>
            </div>
        </div>
