        ...
        <div class="smooth-scroll">
            <div class="container" id="about-page">
                ...
                <section class="about-intro">
                    ...
                    <div class="scroll-text font-accent trans-x hidden sm:flex" data-speed="4"><span>LINGO GROUP LINGO GROUP LINGO
                    ...
                    <div class="wrap-content">
                        ...
                        <div class="value-list ani-item">
                            <div class="box-value color-white">
                                <div class="about-logo-value">
                                    <!-- <svg>
                                        <use xlink:href="#ico-loading-logo">

                                        </use>
                                    </svg>
                                    <span class="circle-rotate">
                                        <svg>
                                            <use xlink:href="#ico-loading-text">

                                            </use>
                                        </svg>
                                    </span> -->
                                    <img src="/images/logo.png" class="w-[100px] h-auto object-cover" />
