...
C57.9,89.7,53.8,90.3,49.6,90.3z" />
        ...
        <div class="navigation"><span></span>
            <nav class="main-menu">
                <ul>
                    <li class="nav-item current"><a class="link-home link-load nav-item-a" href="/"
                            data-name="home-page" aria-label="nav">Trang chủ</a>
                    ...
                    <li class="nav-item"><a class="link-load nav-item-a" href="/truyen-thong.html" data-name="news-page"
                        ...
                        <div class="class-hidden link-change-url" data-hrefen="/media.html"
                            data-hrefvi="/truyen-thong.html" data-title="Truyền thông" data-description="SEN GROUP"
                            data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="/lien-he.html" data-name="contact-page"
                            aria-label="nav">Liên hệ</a>
                        <div class="class-hidden link-change-url" data-hrefen="/contact-us.html"
                            data-hrefvi="/lien-he.html" data-title="Liên hệ" data-description="SEN GROUP"
                            data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                </ul>
            </nav>
    ...
    <div class="header-widget"> <a class="news-regis news-hotline" href="tel:0932929496"
                            ...
                            <div class="slidebox-track">
                                <div class="slidebox-list">
                                    <div class="item-project-home slidebox-item"><span class="logo-pro-home"><svg>
                                        ...
                                        <div class="pic-project-home custom-cursor">
                                            <div class="pic-img"><img
                                                    src="/pictures/mobile/catalog/the-privia/du-an-the-privia-khang-dien-binh-tan.jpg"
                                                    data-src="/pictures/catalog/the-privia/du-an-the-privia-khang-dien-binh-tan.jpg"
                                                    alt="THE PRIVIA" class="lazy"></div><a class="link-load"
                                                href="/cong-ty-thanh-vien/sen-real/the-privia.html"></a>
                                        </div>
                                    </div>
                                    <div class="item-project-home slidebox-item"><span class="logo-pro-home"><svg>
                                                <use xlink:href="#ico-business-logo-01"></use>
                                        ...
                                        <div class="pic-project-home custom-cursor">
                                            <div class="pic-img"><img
                                                    src="/pictures/mobile/catalog/Picity/picity-sky-park-di-an21.jpg"
                                                    data-src="/pictures/catalog/Picity/picity-sky-park-di-an21.jpg"
                                    ...
                                    <div class="item-project-home slidebox-item"><span class="logo-pro-home"><svg>
                                        ...
                                        <div class="pic-project-home custom-cursor">
                                            <div class="pic-img"><img src="/pictures/mobile/catalog/banner/tgc1.jpg"
                                                    data-src="/pictures/catalog/banner/tgc1.jpg" alt="The Global City"
                                    ...
                                    <div class="item-project-home slidebox-item"><span class="logo-pro-home"><svg>
                                        ...
                                        <div class="pic-project-home custom-cursor">
                                            <div class="pic-img"><img
                                                    src="/pictures/mobile/catalog/vinhomes-glory/glory-heights-2-2.jpg"
                                                    data-src="/pictures/catalog/vinhomes-glory/glory-heights-2-2.jpg"
                                    ...
                                    <div class="item-project-home slidebox-item"><span class="logo-pro-home"><svg>
                                        ...
                                        <div class="pic-project-home custom-cursor">
                                            <div class="pic-img"><img
                                                    src="/pictures/mobile/catalog/phu-dong-sky-garden/PDGSky-Garden-9.jpg"
                                                    data-src="/pictures/catalog/phu-dong-sky-garden/PDGSky-Garden-9.jpg"
