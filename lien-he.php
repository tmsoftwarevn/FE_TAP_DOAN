...
<head>
    ...
    <title id="hdtitle">Liên hệ</title>
    ...
    <link rel="alternate" href="/lien-he.html" hreflang="vi-vn">
    <link rel="alternate" href="/contact-us.html" hreflang="en-vn">
    <link href="/lien-he.html" rel="canonical">
    ...
    <main class="main">
        <div class="smooth-scroll">
            <div class="container" id="contact-page">
                ...
                <section class="contact-intro recruitment-intro">
                    ...
                    <div class="pic-contact-intro ani-item">
                            ...
                            <div class="company-info ani-item">
                                ...
                                <ul>
                                    ...
                                    <li><span class="email"><svg>
                                            ...
                                            </svg></span> <a href="mailto:info@sengroup.net">info@sengroup.net</a> </li>
                                </ul>
                            </div>
                            <div class="company-info ani-item">
                                <div class="title-small color-black text-left font-thin">
                                    <div class="title-sp">Văn phòng <strong>Phú Quốc</strong> </div>
                                </div>
                                <ul>
                                    <li class="company-address"><span class="address"><svg>
                                                <use xlink:href="#ico-company-address"></use>
                                        ...
                                        <p><a href="https://www.google.com/maps/place/C%C3%B4ng+Ty+C%E1%BB%95+Ph%E1%BA%A7n+T%E1%BA%ADp+%C4%90o%C3%A0n+SenGroup/@10.7828839,106.6932583,17z/data=!3m1!4b1!4m5!3m4!1s0x31752f72c920c81f:0x5e6f7b7b0e5a5b06!8m2!3d10.7828786!4d106.695447"
                                                target="_blank" rel="noopener">V01-02, SV06, Sonasea Paris Villas, Sonasea Villas &amp; Resort, X. Dương Tơ, TP. Phú Quốc, Kiên Giang</a></p>
                                    </li>
                                    <li><span class="call"><svg>
                                                <use xlink:href="#ico-phone"></use>
                                            </svg></span>
