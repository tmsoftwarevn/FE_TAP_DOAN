...
<head>
    ...
    <meta property="og:image" content="https://sengroup.vn/catalog/view/images/social-share.jpg">
    ...
    <link rel="shortcut icon" href="https://sengroup.vn/catalog/view/images/favicon.svg" type="image/x-icon">
    <link rel="icon" sizes="512x512" href="https://sengroup.vn/catalog/view/images/icon-512.png">
    <link rel="apple-touch-icon" sizes="180x180" href="https://sengroup.vn/catalog/view/images/apple-touch-icon.png">
    <link rel="manifest" href="https://sengroup.vn/manifest.json">
    <link rel="alternate" href="https://sengroup.vn/gioi-thieu.html" hreflang="vi-vn">
    <link rel="alternate" href="https://sengroup.vn/about-us.html" hreflang="en-vn">
    <link href="https://sengroup.vn/gioi-thieu.html" rel="canonical">
    <meta property="og:url" content="https://sengroup.vn/gioi-thieu.html">
    <script>
        ...
        var supports = function(e) {
            if (e == false) {
                window.top.location = 'https://sengroup.vn/detect.html';
            }
        }
        supports();
    ...
    <style id="append">
        ...
        @keyframes fadeInLoadIcon {
            ...
            to {
                opacity: 1;
                filter: drop-shadow(1px 1px 3px var(--color-black10));
                transform: none
            }
        }

        @keyframes scaleLargeBanner {
            0% {
                opacity: 0;
                transform: scale(1.2)
            }
        ...
        *,
        ...
        :root {
            --color-white: #fff;
            --color-whitelight: #f5f5f5;
            --coloractive: #ddbd48;
            --coloractive50: rgba(221, 189, 72, 0.5);
            --bgactive: #004a8f;
            --bgactive-02: #0061BB;
            --bgactive-02-90: rgba(11, 108, 199, 0.9);
            --bglight: rgba(69, 123, 184, 0.6);
            --bgactive05: rgba(0, 74, 143, 0.05);
            --bgactive10: rgba(0, 74, 143, 0.1);
            --bgactive20: rgba(0, 74, 143, 0.2);
            --bgactive30: rgba(0, 74, 143, 0.3);
            --bgactive40: rgba(0, 74, 143, 0.4);
            --bgactive50: rgba(0, 74, 143, 0.5);
            --bgactive60: rgba(0, 74, 143, 0.6);
            --bgactive70: rgba(0, 74, 143, 0.7);
            --bgactive80: rgba(0, 74, 143, 0.8);
            --bgactive90: rgba(0, 74, 143, 0.9);
            --bgactive0: rgba(0, 74, 143, 0);
            --color-red: #ee1f37;
            --color-blue: #004a8f;
            --color-black: #444;
            --color-gray: #6d6e71;
            --titleBig: 3.6rem;
            --titleFont: clamp(26px, 3.2vw, 60px);
            --titleMedium: clamp(26px, 2.6vw, 48px);
            --titlePianoMedium: clamp(24px, 2.2vw, 48px);
            --titleSmall: clamp(22px, 1.5vw, 42px);
            --fontText: 1.5rem;
            --wraplarge: 82vw;
            --wrapcontent: 82vw;
            --wrapsmall: 50vw;
        ...
        .loadicon {
            position: fixed;
            --size: 17vw;
            --sizeheight: calc(var(--size) * 250/220);
            width: var(--size);
            height: var(--sizeheight);
            top: calc(44% - var(--sizeheight)/2);
        ...
        .loadicon>span::after {
            content: '';
            position: absolute;
            background: linear-gradient(90deg, var(--color-white0), var(--color-white), var(--color-white), var(--color-white0));
            width: 8rem;
            height: 27rem;
            top: -5rem;
            left: -18rem;
        ...
        .loadicon.load-done>span {
            animation-name: fadeIn;
            animation-duration: .5s;
            animation-fill-mode: forwards
        }

        .loadicon.load-done>span::after {
            animation-name: SliceLight;
        ...
        .loading-light span:nth-child(1) {
        ...
        .loading-light span:nth-child(2) {
            animation-duration: 5s;
            position: absolute;
            width: 4vw;
            height: 4vw;
        ...
        .loading-light span:nth-child(3) {
        ...
        .mask-color::after {
            content: '';
            box-shadow: inset 0 0 10vw 6vw var(--color-black40);
        ...
        .flower-left {
            position: absolute;
            height: 105vh;
            width: calc(1000/1200*105vh);
            left: -20vh;
            top: 7vh
        }

        .flower-mask.show .flower-right span:nth-child(1) {
            animation: goLeft 1.2s ease .3s forwards
        }

        .flower-mask.show .flower-right span:nth-child(2) {
            animation: goRight 1.2s ease .7s forwards
        }

        .flower-mask.show .flower-right span:nth-child(3) {
            animation: fadeInDown 1.2s ease 1.2s forwards
        }

        .flower-mask.show .flower-left span:nth-child(1) {
            animation: fadeInUp 1.2s ease .5s forwards
        }

        .flower-mask.show .flower-left span:nth-child(2) {
            animation: flipInX 1.2s ease .9s forwards
        }
        ...
        .enter-site span::after {
            ...
            border-top: 4px solid var(--coloractive);
            top: calc(100% + 4px);
            left: calc(50% - 2px)
        }
        ...
        .scroll-dragging .scrollbar-thumb {
            cursor: grabbing
        }
        ...
        .logo {
            ...
            width: var(--widthlogo);
            height: calc(220/250*var(--widthlogo));
            left: calc(50% - var(--widthlogo)/2);
            transition: all .3s ease-in-out;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .nav-item.current,
        .navigation>span,
        .outer-nav.second .sub-nav li .sub-nav-a.current,
        .sub-company li.current,
        .sub-nav li.current {
            pointer-events: none
        }
        ...
        .close-menu {
            ...
            --widthclose: 1.5rem;
            top: 3rem;
            width: var(--widthclose);
            height: var(--widthclose);
            z-index: 100
        }
        ...
        .close-menu .toggle-2 {
            top: calc(50% - .4rem);
            right: calc(50% - var(--widthclose)/2);
            opacity: 0;
            transition: transform .6s, opacity 0s .6s
        }
        ...
        .close-menu.show .toggle-1,
        .close-menu.show .toggle-2 {
            opacity: 1;
        ...
        .news-regis.load-subscribe .text-news-regis {
            font-size: 13px;
            top: calc(50% - 17px)
        }
        ...
        .search-overlay>span {
            background-color: var(--bgactive70);
            height: 100%;
            width: 100%;
            position: fixed;
            left: 0;
        ...
        .search-svg {
            ...
            transition: all .3s ease-in-out;
            cursor: pointer;
            box-shadow: 0 5px 10px var(--color-white10)
        }
        ...
        .home-banner .box-video-center {
            width: calc(560/315*100vh);
            height: 100vh;
            top: 50%;
            left: 50%;
        ...
        .home-banner .box-video-center::after {
            content: '';
            position: absolute;
            width: 100vw;
            height: 100vh;
        ...
        .banner-inner+section {
            box-shadow: inset 0 20px 20px -15px var(--bgactive40)
        }
        ...
        .sub-nav li .sub-nav-a.current {
            pointer-events: none
        }

        .download-but a:hover,
        .sub-nav li .sub-nav-a.active-color,
        .sub-nav li .sub-nav-a.current {
            background-color: var(--coloractive)
        }
        ...
        .outer-nav.second .sub-nav ul {
            display: inline-block;
            overflow: visible;
            box-shadow: 0 5px 15px rgba(0, 0, 0, .2)
        }

        .outer-nav.second .sub-nav li .sub-nav-a {
            background-color: var(--color-white);
            font-size: 12px;
            padding: 11px 15px
        }
        ...
        @media (pointer:fine) {
            ...
            .cursor-bg .circle-rotate-cursor,
            .cursor-bg>svg {
                position: absolute;
                width: 90%;
                height: 90%;
            ...
            .cursor-bg .circle-rotate-cursor svg {
                position: absolute;
                width: 100%;
                height: 100%;
                top: 0;
            ...
            #cursor.active .cursor-bg .circle-rotate-cursor svg {
                animation: Preloader 3s infinite linear
            }
            #mouse-cursor {
                top: 0;
                ...
                width: var(--width);
                height: var(--height);
                transform: translate(calc(var(--x) - var(--width)/2), calc(var(--y) - var(--height)/2)) rotate(45deg);
                transition: .1s transform cubic-bezier(.39, .575, .565, 1), .3s backgroundColor cubic-bezier(.39, .575, .565, 1);
        ...
        @media screen and (min-width:1100px) {
            .banner-inner.show .bg-inner,
            .banner-inner.show .bg-inner::after {
                animation-name: fadeIn;
            ...
            .banner-inner .bg-inner::after {
                ...
                top: 0;
                left: 0;
                background: linear-gradient(180deg, rgba(0, 0, 0, .5), rgba(242, 179, 77, 0) 60%);
                z-index: 9;
                pointer-events: none;
                mix-blend-mode: multiply;
                opacity: 0
            ...
            .banner-inner.show .bg-inner {
                animation-name: scaleLargeBanner
            }
            .home-banner .box-video-center.horz {
                width: 100vw;
                height: calc(315/560*100vw)
            }
            .home-banner .box-video-center.horz .controls {
                bottom: calc(50% - 46vh)
            }
        ...
        @media screen and (max-width:1100px) {
            :root {
                ...
                --titleFont: 4vw;
                --titleMedium: 3.5vw;
                --titleSmall: clamp(18px, 2.2vw, 30px);
                --fontText: 1.3rem;
                --wrapcontent: 90vw;
                --wrapsmall: 90vw;
                --widthmenu: 100vw;
            ...
            .banner-inner {
                --heightbanner: max(calc(1125/2000 * 100vw), 300px)
            }
            .banner-inner,
            .bg-inner .bg {
            ...
            .outer-nav.second.fixed.level-index-out {
                z-index: 0
            }
            .outer-nav.second .sub-nav li .sub-nav-a {
                padding: 10px 15px;
            ...
            .section-outernav.outernav-option-02 {
                background-color: #fff
            }
            .flower-left,
            .flower-right {
                height: 63vh;
                width: calc(1000/1500*63vh);
                top: auto;
                bottom: -5vh;
                opacity: .5
            }
            .flower-left {
                width: calc(1000/1200*63vh);
                left: -22vh;
                bottom: -3vh
            }
            .mask-color::after {
        ...
        .bg-cover.bg-lazy.bg-show::after,
        html[lang=en] .draw-en,
        html[lang=vi] .draw-vi {
            display: block
        }
        ...
        .date {
            ...
            justify-content: center;
            text-align: center;
            box-shadow: 5px 5px 8px var(--color-black10);
            z-index: 10;
            top: -15px;
            left: 10px;
            width: 58px;
        ...
        .slide-background .slidebox-pagination {
            position: absolute;
            width: auto;
            height: auto;
            margin: 0;
        ...
        .view-line {
            ...
            top: calc(50% - 3px);
            left: 100%;
            background-color: var(--bgactive30);
            transform-origin: left
        }

        .small-logo-ico-more,
        .view-more .viewmore-svg {
            position: relative;
            display: inline-block;
            vertical-align: middle
        }
        ...
        .small-logo-ico-more {
            ...
            top: calc(50% - 1.3rem);
            color: var(--color-white);
            margin: 0 2.2rem 0 20px
        }

        .small-logo-ico-more::after {
            content: '';
            position: absolute;
            width: calc(100% + 20px);
        ...
        .text-home-intro .title-main h2 {
            padding-left: var(--padding-dis)
        }
        ...
        .box-txt-home-intro {
            ...
            display: block;
            max-width: 500px;
            padding: 4rem 0 0 var(--padding-dis)
        }

        .box-txt-home-intro::before {
            content: '';
            position: absolute;
            width: 3rem;
            height: 3rem;
            top: 0;
            left: var(--padding-dis)
        }

        .pic-home-intro {
            position: absolute;
            width: 75vh;
            height: calc(15/12*75vh);
            bottom: 0;
            right: 6rem;
            z-index: 1
        }
        ...
        .svgMask {
            position: relative;
            filter: drop-shadow(0 20px 30px var(--color-black20));
            z-index: 2
        }
        ...
        .all-tab-bus .tab-content.active,
        .home-business .wrap-content {
            display: flex;
            align-items: center
        }

        .home-business .left-content {
            width: 30%
        }
        ...
        .business-home {
            position: absolute;
            --sizebox: calc(var(--size)/2.2);
            width: var(--sizebox);
            height: var(--sizebox)
        }

        .business-home .box-img {
            position: absolute;
            width: 100%;
            height: 100%;
            top: 0;
        ...
        .business-home:nth-child(1) {
            top: 0;
            left: calc(50% - var(--sizebox)/2)
        }

        .business-home:nth-child(2) {
            top: calc(50% - var(--sizebox)/2);
            left: 0
        }

        .business-home:nth-child(3) {
            top: calc(50% - var(--sizebox)/2);
            right: 0
        }

        .business-home:nth-child(4) {
            bottom: 0;
            left: calc(50% - var(--sizebox)/2)
        }

        .business-home:nth-child(5) {
            top: calc(50% - var(--sizebox)/2);
            left: calc(50% - var(--sizebox)/2)
        }

        .home-business .svg-stroke,
        .logo-bus-home {
            position: absolute;
            width: 100%;
            height: 100%;
        ...
        .business-home:nth-child(1) .logo-bus-home svg {
            top: -1.5rem
        }

        .business-home:nth-child(2) .logo-bus-home svg {
            left: -1rem
        }

        .business-home:nth-child(3) .logo-bus-home svg {
            right: -1rem
        }

        .business-home:nth-child(4) .logo-bus-home svg {
            bottom: -1.5rem
        }
        ...
        .content-bus-tab-home p {
            font-size: .9rem
        }

        .content-bus-tab-home::before {
            content: '';
            position: absolute;
            width: 1px;
            height: 100%;
        ...
        .tab-content.active .content-bus-tab-home::before {
            transform: none
        }
        ...
        .item-project-home .title-post {
            margin-bottom: 1.5rem
        }

        .item-project-home .title-post h3 {
            color: var(--bgactive);
            font-size: var(--titlePianoMedium)
        }
        ...
        .text-project-home .title-post h3,
        .text-project-home p {
            overflow: hidden;
            display: -webkit-box;
            -webkit-box-orient: vertical;
        ...
        .text-project-clone {
            ...
            top: 0;
            left: 0;
            clip-path: polygon(0 0, 30.2% 0, 30.2% 100%, 0 100%);
            opacity: 0;
            transition: opacity .6s ease-in-out;
            z-index: 9
        }

        .slidebox-item.is-active:not(.is-next) .text-project-clone {
            opacity: 1
        }

        .slidebox-item.is-active:not(.is-next) .pic-project-home {
            pointer-events: auto
        }

        .item-project-home.slidebox-item.is-active:not(.is-next) {
            opacity: 1
        }

        .text-project-clone .title-post h3,
        .text-project-clone p {
            color: var(--color-white)
        }

        .slide-project.true-option {
            padding-bottom: 60px
        }

        .slide-project .slidebox-arrows {
            left: 10rem;
            top: auto;
            bottom: 20px;
            width: 80px;
        ...
        .slide-project .slidebox-arrow {
            width: 35px;
            height: 35px
        }

        .slide-project .slidebox-arrow-next::before {
            left: auto;
            right: -35px
        }

        .slide-project .slidebox-arrow-prev::before {
            right: auto;
            left: -35px
        }

        .slide-project .slidebox-arrow-prev {
            color: var(--color-white)
        }
        ...
        .home-news .big-view.wrap-view-details {
            position: absolute;
            left: 0;
            top: 13rem
        }

        .big-view .view-details {
            font-size: 16px
        }

        .big-view .viewdetails-svg {
            width: 18px;
            height: 18px;
            margin: -3px 0 0 10px
        }

        .big-view .small-logo-ico {
            width: 3.6rem;
            height: 3.6rem;
            top: calc(50% - 1.8rem)
        }
        ...
        .about-intro .wrap-content {
            padding: 7rem 0 11rem calc(var(--wrapcontent)/2 + 2rem)
        }
        ...
        .about-logo-value .circle-rotate,
        .about-logo-value svg {
            position: absolute;
            top: 0;
            left: 0;
            width: 100%;
        ...
        .pic-about-achievement {
            position: absolute;
            width: 37rem;
            height: calc(11/12*37rem);
            top: -12rem;
            right: -3rem;
            z-index: 1
        }
        ...
        .pic-achievement {
            overflow: hidden;
            padding: 20px;
            border: 1px solid var(--bgactive50);
            background-color: var(--color-white)
        }
        ...
        .stroke-page {
            ...
            top: 0;
            left: 50%;
            background-color: var(--bgactive20)
        }

        .pic-business-01,
        .pic-business-02 {
            width: 80vh;
            height: calc(12/10*80vh)
        }
        ...
        .pic-business-page .bg-cover {
            border-radius: 12px;
            overflow: hidden;
            filter: drop-shadow(0 5px 10px var(--color-black10))
        }
        ...
        .join-us h2,
        .text-business-page .title-post h2 {
            font-size: var(--titlePianoMedium)
        }

        .text-business-page p,
        .text-member-page p {
            margin: 0 0 1.5rem
        }

        .content-business-page:nth-child(even) {
            flex-direction: row-reverse
        }

        .member-section .stroke-page {
            left: calc(50vw - var(--wrapcontent)/2 + 12rem)
        }

        .member-section .wrap-content {
            padding: 0
        }
        ...
        .pic-member-page .logo-bus-home svg {
            width: 34%;
            height: 34%
        }

        .pic-member-page::after {
            content: '';
            position: absolute;
            width: 60%;
            height: 60%;
        ...
        .company-info li span svg,
        .logo-member-intro svg,
        .member-intro .box-txt::after,
        .share ul li svg {
            position: relative;
            display: block;
            width: 100%;
        ...
        .sub-company li .sub-company-a svg {
            width: 5.5rem;
            height: 5.5rem
        }

        .sub-company li .sub-company-a.current {
            pointer-events: none
        }

        .sub-company li .sub-company-a.active-color,
        .sub-company li .sub-company-a.current {
            color: var(--bgactive);
            background-color: var(--coloractive)
        }

        .news-list-section .wrap-content {
            padding-top: 1rem
        }
        ...
        .news-relative .pic-news .pic-img,
        .project-relative .pic-news .pic-img {
            box-shadow: 0 5px 10px var(--color-black20)
        }

        .news-relative .wrap-view-details {
            left: 15px
        }

        .project-relative .wrap-content {
            max-width: 1300px;
            padding-bottom: 2rem
        }

        .project-relative .item-news {
            padding: 30px 20px 0
        }

        .project-relative .txt-news {
            text-align: center
        }

        .project-relative .txt-news h3 {
            color: var(--bgactive);
            font-size: 1.3rem;
            font-weight: 600
        }

        .project-relative .txt-news p {
            padding: 10px
        }
        ...
        .project-relative .wrap-view-details {
            left: 50%;
            transform: translateX(-50%)
        }

        #news-details-page .section-outernav {
            padding: 3rem 0
        }

        .report-group {
            background: linear-gradient(0deg, #e6edf3, #fff)
        }

        .report-group .wrap-content {
            max-width: 1200px;
            padding-top: 30px
        }
        ...
        .list-box.hide,
        .slide-number .slidebox-arrow::before {
            display: none
        }
        ...
        .r-text {
            ...
            background-color: var(--color-white);
            color: var(--color-black);
            box-shadow: 0 5px 10px var(--color-black10)
        }
        ...
        .slide-library-report .bg-item-album {
            padding: 10px
        }

        .slide-library-report .pic-library .pic-img {
            padding-top: 130%
        }

        .slide-library-report .item-album {
            background-color: var(--color-white0);
            padding: 0
        }

        .slide-library-report .item-album .pic-library {
            box-shadow: none;
            border-radius: 15px
        }
        ...
        .slide-number.arrow-outside .slidebox-arrows {
            width: 100%
        }

        .slide-number.arrow-outside .slidebox-arrow-prev {
            width: 30px;
            height: 30px;
            left: -50px;
            top: 12px
        ...
        .slide-number.arrow-outside .slidebox-arrow-next {
            width: 30px;
            height: 30px;
            right: -50px;
            top: 12px
        ...
        .slidebox-slide.slide-number:not(.true-option) .slidebox-list,
        .slidebox-slide.slide-three:not(.true-option) .slidebox-list {
            justify-content: center
        }
        ...
        .project-details-intro .breadcrumb ul {
            justify-content: flex-start
        }

        .project-details-intro .left-content {
            width: 100%
        }

        .project-details-intro .left-content .title-main {
            width: 80%
        }

        .project-details-intro .right-content {
            width: 100%;
            padding: 0 0 30px
        }

        .project-details-intro .box-text {
            max-width: unset
        }
        ...
        .contact-form-project .title-main strong,
        .share>span,
        .text-pro-slide-intro {
            display: block;
            position: relative
        ...
        .contact-form-project .line-bottom {
            height: 4px;
            background-color: var(--color-white)
        }

        .contact-form-project .wrap-content {
            max-width: 1300px
        }

        .contact-form-section.contact-form-project {
            padding: 2vw 0
        }
        ...
        .contact-intro .scroll-text {
            bottom: 0
        }

        .contact-intro .wrap-all-company>.title-small strong {
            position: relative;
            display: block;
            font-size: var(--titleMedium);
            width: 100%
        ...
        .wrap-all-company>.title-small {
            width: 50%
        }

        .wrap-all-company .company-info {
            width: 50%;
            padding: 0 12% 4rem 0;
            margin: 0
        }

        .wrap-all-company .company-info .title-small {
            margin: 0 0 10px
        }
        ...
        .contact-form .input-area textarea:focus {
            background-color: var(--color-white);
            color: var(--color-black);
            border-radius: 12px
        }
        ...
        .contact-form-section .wrap-content {
            display: flex
        }

        .contact-form-section .subscribe-footer {
            margin-left: 50%
        }

        .contact-form-section .social-footer {
            position: absolute;
            bottom: -45px
        }

        .about-intro.recruitment-intro .wrap-content {
            padding: 7rem 4rem 9rem calc(var(--wrapcontent)/2 + 2rem)
        }

        .about-intro.recruitment-intro .pic-about-intro {
            width: 34rem;
            height: calc(11/12*34rem);
            left: 7rem
        }

        .recruitment-intro .title-main {
            width: 50vw
        }
        ...
        .recruitment-enviroment .wrap-content {
            padding: 5vw 0 13vw 41%
        }
        ...
        .recruitment-enviroment .scroll-text {
            opacity: .1;
            mix-blend-mode: overlay;
            bottom: .5rem;
            z-index: 2
        ...
        .recruitment-career .line-bottom {
            height: 3px;
            background-color: var(--color-white)
        }
        ...
        .join-us .input-area textarea:focus,
        .join-us .input-text input[type=text]:focus {
            background-color: var(--color-white);
            color: var(--color-black)
        }

        .join-us .input-area textarea {
            background-color: var(--bglight);
            border: 0;
            color: var(--color-white);
            border-radius: 10px
        ...
        .join-group .pic-member-intro-01,
        .join-group .pic-member-intro-02 {
            width: 770px;
            height: 770px;
            bottom: -170px;
            top: auto;
        ...
        .table-recruitment thead th {
            ...
            text-align: center;
            margin: 0 5px;
            border-bottom: 6px solid var(--bgactive)
        }

        .table-recruitment tbody td::after,
        .table-recruitment thead th::after {
            content: '';
            position: absolute;
            width: 100%;
            height: 100%;
        ...
        .table-recruitment thead th {
            ...
            position: relative;
            background: 0 0;
            border-right: 6px solid var(--bgactive)
        }
        ...
        .table-recruitment th:nth-child(1) {
            width: 90px
        }
        ...
        .table-recruitment tbody tr:nth-child(1) td:after {
            border-radius: var(--radius) var(--radius) 0 0
        }

        .table-recruitment tbody tr:last-child td::after {
        ...
        .loading>div {
            ...
            border-radius: 50%;
            animation: .75s bounce infinite alternate
        }
        ...
        .list-view {
            ...
            scrollbar-color: #aaa;
            scrollbar-width: none;
            border: 1px solid var(--bgactive20)
        }
        ...
        .list-view li {
            ...
            border-bottom: 1px solid var(--bgactive20);
            cursor: pointer;
            transition: all .3s ease-in-out;
            color: var(--bgactive)
        }
        ...
        .list-view ul li>div a,
        .list-view ul li>div p {
            color: inherit;
            position: relative;
            display: block;
        ...
        .company-text .title-main {
            width: 55%
        }

        .company-text .title-main h2 {
            font-size: clamp(26px, 2.6vw, 48px)
        }

        .company-text .title-main h2 strong {
        ...
        .company-text .title-small {
            margin: .2rem 0 10px
        }

        .company-text .title-small .title-sp {
            font-weight: 300
        }
        ...
        .subscribe-footer .title-small .title-sp {
            font-weight: 600;
            font-size: 1.2rem
        }
        ...
        .subscribe .input-text input[type=text] {
            background: unset;
            border-bottom: 1px solid var(--color-white40);
            color: var(--color-white)
        }

        .subscribe .input-text input[type=text]:focus {
            background: #fff;
            color: var(--color-black)
        }
        ...
        .is-mac .social-footer ul li::after {
            top: calc(50% - 5px)
        }
        ...
        .load-search-list .item-search .title-search {
            padding: 2rem
        }

        .search-result .wrap-content {
            max-width: 1100px
        }
        ...
        .item-search .title-search {
            width: 58%;
            padding: 3rem 2rem;
            margin: 0
        }

        .item-search .title-search h3 {
            font-size: 1rem;
            font-weight: 400;
            line-height: 1.5;
            margin: 0 0 10px;
        ...
        .select-selected {
            ...
            padding: 17px 14px;
            border: 0;
            border-bottom: 1px solid var(--bgactive50);
            cursor: pointer;
            color: var(--bgactive);
            font-size: 16px;
            font-weight: 300;
        ...
        .select-selected::after {
            ...
            border-color: var(--bgactive50) transparent transparent;
        ...
        .section-thankyou .bg-cover::after {
            content: '';
            position: absolute;
            width: 100%;
            height: 50%;
            ...
            left: 0;
            pointer-events: none;
            background: linear-gradient(0deg, var(--bgactive50), var(--color-black0));
            opacity: 0;
            mix-blend-mode: multiply;
            z-index: 5
        }

        .section-thankyou.show .bg-cover::after {
            animation-name: fadeIn;
            animation-duration: 1.5s;
            animation-delay: .5s;
            animation-fill-mode: forwards
        ...
        .content-thankyou {
            ...
            text-align: center;
            border-radius: 15px;
            box-shadow: 0 5px 20px var(--color-black10);
            z-index: 10
        }
        ...
        .content-thankyou .wrap-view-details {
            display: flex;
            justify-content: center;
            margin: 2rem 0 0
        }

        .section-thankyou .line-bottom {
            height: 5px;
            background-color: var(--color-white)
        }

        .flower-notfound,
        .flower-notfound span {
            position: absolute;
            width: 100%;
            height: 100%;
            top: 0;
        ...
        .flower-notfound.show .flower-right span:nth-child(1) {
            animation: goLeft 1.2s ease .3s forwards
        }

        .flower-notfound.show .flower-right span:nth-child(2) {
            animation: goRight 1.2s ease .7s forwards
        }

        .flower-notfound.show .flower-right span:nth-child(3) {
            animation: fadeInDown 1.2s ease 1.2s forwards
        }

        .flower-notfound.show .flower-left span:nth-child(1) {
            animation: fadeInUp 1.2s ease .5s forwards
        }

        .flower-notfound.show .flower-left span:nth-child(2) {
            animation: flipInX 1.2s ease .9s forwards
        }
        ...
        .load-details>.wrap-content {
            max-width: 1200px;
            padding: 3rem;
            box-shadow: 0 7px 20px var(--color-black10)
        }
        ...
        .input-text input[type=text]:focus {
            ...
            background-color: var(--bgactive);
            color: var(--color-white);
            box-shadow: 0 10px 25px var(--color-black10)
        }
        ...
        .close-format .toggle-1,
        .close-format .toggle-2 {
            top: 50%;
            right: calc(50% - var(--widthclose)/2);
            transform: rotate(45deg);
        ...
        .album-center .slidebox-arrow-prev::before {
            top: calc(50% - 30px);
            font-size: 15px;
            right: -40px
        }

        .album-center .slidebox-arrow-next::before {
            top: calc(50% - 30px);
            font-size: 15px;
            left: -40px
        }
        ...
        .all-pics.has-background .full img {
            background-color: var(--bgactive);
            box-shadow: 0 10px 30px var(--color-white20);
            border: 1px solid var(--coloractive)
        }
        ...
        .box-video-center {
            width: var(--wrapcontent);
            height: calc(315/560*var(--wrapcontent));
            position: relative;
            display: block;
            margin: 0;
            padding: 0;
        ...
        .controls::after {
            ...
            height: 100%;
            bottom: 0;
            background-color: var(--bgactive0);
            border-radius: 30px;
        ...
        .overlay-dark {
            background: linear-gradient(45deg, var(--coloractive) 30%, var(--bgactive90) 60%);
            opacity: .5;
            transform: scale(0);
            height: 200vw;
            width: 200vw;
        ...
        .details-center {
            ...
            background-color: #fff;
            color: #444;
            box-shadow: 0 5px 20px var(--color-white10);
            z-index: 5
        }
        ...
        .details-text a,
        .details-title h2,
        .slide-popup-details .slidebox-pagi-item {
            color: var(--bgactive)
        }
        ...
        .slide-popup-details.true-option .slidebox-pagination {
            padding: 0;
            margin: 0 auto
        }
        ...
        .register::after {
            ...
            bottom: 0;
            background: linear-gradient(-135deg, var(--bgactive90) 40%, var(--bgactive-02-90))
        }
        ...
        .register .close-regis {
            position: absolute;
            opacity: 0;
            pointer-events: none
        }

        .register.show .close-regis {
            animation-name: fadeIn;
            animation-duration: 1s;
            animation-delay: .5s;
            animation-fill-mode: forwards;
        ...
        .register .title-small .title-sp {
            margin: 0 0 10px;
            font-size: 26px
        }

        .register .title-small p {
            color: var(--color-black);
            font-size: 14px
        }
        ...
        .company-regis-info,
        .company-regis-info span,
        .company-regis-info::before,
        .regis-info,
        .register p,
        .social-regis,
        .social-regis ul li {
        ...
        .company-regis-info span svg,
        .social-regis ul li a svg {
            position: relative;
            display: block;
            width: 100%;
            height: 100%
        ...
        .company-regis-info p {
            width: calc(100% - 25px);
            padding-left: 1rem;
            text-align: left
        }

        .company-regis-info a {
            font-size: 15px;
            font-weight: 400;
            color: inherit;
            text-align: left
        ...
        .contact-success {
            ...
            box-shadow: var(--box-shadow-fs-light);
            opacity: 0;
            border-radius: 10px;
            z-index: 99999
        }
        ...
        @media screen and (max-width:1100px) {
            ...
            .home-banner {
                --heightbanner: calc(1125/2000 * 100vw)
            }
            .slide-background .bg {
                height: auto
            }
            ...
            .home-business .left-content .title-main {
                text-align: center
            }
            .business-home-list {
                --size: min(90vw, 600px);
            ...
            .home-business .all-tab-content {
                ...
                border: 1px solid var(--coloractive50);
                padding: 3rem;
                top: auto;
                opacity: 1;
                min-height: unset;
            ...
            .pic-home-business::after {
                ...
                bottom: 0;
                left: 0;
                background: linear-gradient(0deg, var(--bgactive), var(--bgactive0))
            }
            .content-bus-tab-home h3 {
                color: var(--color-white);
                transition: color .3s ease-in-out;
            ...
            .content-bus-tab-home.active h3 {
                color: var(--coloractive)
            }
            .content-bus-tab-home::after {
                content: '';
                position: absolute;
                width: 100%;
                height: 1px;
            ...
            .content-bus-tab-home.active::after {
                animation-name: scaleSmallX;
                animation-duration: 1s;
                animation-delay: .3s;
                animation-fill-mode: forwards
            }
            .content-bus-tab-home.active {
                margin: 0 0 20px
            }
            .content-collapse {
                height: 0;
            ...
            .text-project-clone {
                clip-path: polygon(0 0, 26.7% 0, 26.7% 100%, 0 100%)
            }
            .slide-project.true-option .slidebox-pagination {
                margin: 0;
                bottom: -2rem;
                left: 11rem;
                justify-content: flex-end;
            ...
            .about-intro .wrap-content {
                padding: 6vw 0 14vw 45vw
            }
            .pic-about-intro {
                width: 45vw;
                height: calc(11/12*45vw);
                bottom: 0;
                left: 0
            }
            .wrap-chart {
            ...
            .member-section .stroke-page {
                left: calc(50vw - var(--wrapcontent)/2 + 10rem)
            }
            .content-member-page {
                margin: 5vw 0
            }
            ...
            .contact-form-project .title-main,
            .load-title h2 {
                text-align: center
            }
            .contact-form-project .title-underline::after {
                margin: 12px auto 0
            }
            .contact-form-project .big-view .view-details {
                margin: 40px auto 0
            }
            .share {
                position: relative;
            ...
            .table-recruitment table td a,
            .table-recruitment tbody td {
                font-size: 14px
            }
            .pic-contact-intro {
                width: 25rem;
                height: calc(14/8*25rem);
                top: 15%;
                right: 2rem
            }
            .contact-intro {
            ...
            .flower-right {
                right: -5vw;
                width: calc(1000/1500*60vw)
            }
            .flower-left {
                width: calc(1000/1200*60vw);
                left: -8vw
            }
            .wrap-box-footer .company-text {
                margin: 0 0 3rem
            ...
            .search-loading .item-search {
                margin: 15px 0
            }
            .search-loading .item-search:nth-child(1) {
                margin-top: 30px
            }
            .print-box {
                width: 100%;
        ...
        @media screen and (max-width:780px) {
            ...
            .table-recruitment td:last-child {
                border-bottom: 15px solid var(--bgactive)
            }
            ...
            .table-recruitment tbody tr td:last-child::after {
                border-radius: 0 0 var(--radius) var(--radius)
            }
        }
        ...
        @media screen and (max-width:580px) {
            ...
            .text-project-clone {
                clip-path: polygon(0 0, 27.8% 0, 27.8% 100%, 0 100%)
            }
            .logo-pro-home {
                width: 15vw;
                height: 15vw
            ...
            .stroke-page {
                background-color: var(--bgactive10)
            }
            .content-business-page,
            .content-business-page:nth-child(even) {
                margin: 5rem 0
            ...
            .content-member-page:nth-child(even) {
                background-color: var(--bgactive05)
            }
            .pic-member-page {
                margin: 0 auto
            }
            ...
            .pic-member-01 {
                width: 70vw;
                height: calc(12/10*70vw);
                top: 5%;
                right: -10vw
            }
            .pic-member-02 {
                width: 66vw;
                height: calc(12/10*66vw);
                top: 50%;
                left: -8vw
            }
            .pic-member-03 {
            ...
            .news-relative .slide-news-relative .txt-news h3 {
                display: -webkit-box;
                -webkit-box-orient: vertical;
                -webkit-line-clamp: 2;
                overflow: hidden;
            ...
            .slide-number.arrow-outside.true-option .slidebox-arrow {
                display: block
            }
            .slide-number.arrow-outside .slidebox-arrow-prev {
                width: 22px;
            ...
            .flower-right {
                right: -15vw;
                width: calc(1000/1500*80vw)
            }
            .flower-left {
                width: calc(1000/1200*80vw);
                left: -18vw
            }
            .date {
                font-size: 20px
        ...
        .load-search-list::-webkit-scrollbar {
            width: 7px !important
        }
        ...
        .slidebox-arrow {
            ...
            padding: 5px;
            border: 0;
            filter: drop-shadow(4px 4px 4px rgba(0, 0, 0, .06))
        }
        ...
        .slidebox-arrow-next::before,
        .slidebox-arrow-prev::before {
            position: absolute;
            width: auto;
            height: 50px;
            line-height: 50px;
        ...
        .slidebox-pagi-num.is-active svg {
            opacity: 1
        }

        .slidebox-pagi-num.is-active .circle-outer {
            stroke: var(--coloractive);
        ...
        .dot-dark .slidebox-pagi-item.is-active {
            color: var(--coloractive)
        }
        ...
        @media (hover:hover) and (pointer:fine) and (min-width:1100px) {
            ...
            .slidebox-has-num .slidebox-pagi-item:hover {
                color: var(--coloractive)
            }
        }
        ...
        @media screen and (max-width:1100px) {
            ...
            .slidebox-draggable.true-option .slidebox-item {
                cursor: default
            }
            .slidebox-draggable.true-option .slidebox-item:focus {
                cursor: default
            }
            .single .slidebox-item,
            .single .slidebox-list {
                width: 100% !important;
                margin: 0 !important
            }
            .slidebox-pagi-item {
            ...
            .slidebox-has-num .slidebox-pagi-item {
                font-size: 12px;
                width: 26px;
                height: 26px
            }
        ...
        @media screen and (min-width:1100px) {
            .arrow-outside.true-option .slidebox-arrows {
                display: block;
                position: absolute;
                width: 100%;
                left: 0;
            ...
            .arrow-outside .slidebox-arrow-next {
                right: -80px
            }
        }
    </style>
    <script type="application/ld+json">
        {
            ...
            "@type": "Organization",
            "url": "https://sengroup.vn/",
            "name": "SEN GROUP",
            "logo": ["https://sengroup.vn/catalog/view/images/social-share.jpg"],
            "contactPoint": {
                "@type": "ContactPoint",
                "telephone": "0932929496",
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [
                [{
                    ...
                    "position": 1,
                    "name": "SEN GROUP",
                    "item": "https://sengroup.vn/"
                }],
                [{
                    "@type": "ListItem",
                    "position": 2,
                    "name": "Giới thiệu",
                    "item": "https://sengroup.vn/gioi-thieu.html"
                }]
            ]
        }
    </script>
    <script type="application/ld+json">
        {
            ...
            "@type": "WebSite",
            "name": "Giới thiệu",
            "alternateName": "SEN GROUP",
            "url": "https://sengroup.vn/gioi-thieu.html"
        }
    </script>
    <!-- Google Tag Manager -->
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-544D3QK');
    </script>
    ...
    <script>
        (function(w, d, s, l, i) {
            ...
            j.src =
                'https://www.googletagmanager.com/gtm.js?id=' + i + dl;
            f.parentNode.insertBefore(j, f);
        })(window, document, 'script', 'dataLayer', 'GTM-KKQMJLD');
    </script>
    <!-- End Google Tag Manager -->
...
<body>
    <div id="render-styles"></div><noscript id="deferred-styles"><link rel="stylesheet" href="https://sengroup.vn/catalog/view/css/app.css?ver=1.0.8"></noscript>
    ...
    <div class="loadicon" style="display:none"><span></span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 250"><path class="stroke-line" d="M181.5,40.8c0-0.2-0.1-0.3-0.3-0.4c-0.1,0-0.2,0-0.3,0c-7.1,0.7-21.1,2.4-35.7,6.5c-2,0.6-4,1.2-5.9,1.8
...
h-2.2v9.2h2.2c1.3,0,2.3-0.4,2.9-1.1c0.6-0.7,0.9-1.9,0.9-3.6c0-1.6-0.3-2.8-0.9-3.5C201.8,218.4,200.8,218.1,199.5,218.1"/></svg></div>
    <script>
    ...
    <header class="header">
        <div class="logo"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 250"><path fill="#DEBD4C" d="M181.5,40.8c0-0.2-0.1-0.3-0.3-0.4c-0.1,0-0.2,0-0.3,0c-7.1,0.7-21.1,2.4-35.7,6.5c-2,0.6-4,1.2-5.9,1.8
c-1.6-2.6-3.4-5.2-5.4-7.8c-8.9-12.1-18.8-22-23.9-26.8c-0.2-0.2-0.4-0.2-0.6,0c-5.1,4.8-15,14.7-23.9,26.8
c-1.9,2.6-3.7,5.2-5.4,7.8c-1.8-0.6-3.8-1.2-5.9-1.8c-14.6-4.1-28.6-5.8-35.6-6.5c-0.1,0-0.2,0-0.3,0c-0.2,0.1-0.3,0.2-0.3,0.4
c0,6.9,0.3,20.6,2.9,35.1c2.1,12.1,5.4,22.2,9.7,30.1c5.6,10.4,13,17,21.9,19.7c7.7,2.3,14.9,2.5,21.5,0.6c3.8-1.1,7.2-2.9,10.3-5.4
c1.7,0.1,3.5,0.2,5.4,0.2c1.8,0,3.7,0,5.4-0.2c3,2.5,6.5,4.3,10.3,5.4c3,0.9,6.1,1.3,9.3,1.3c3.9,0,8-0.6,12.2-1.9
...
c0.4,0,0.6-0.1,0.7-0.2c0.1-0.1,0.1-0.3,0.1-0.7v-15.1c0-0.3,0-0.6-0.1-0.7c-0.1-0.1-0.3-0.2-0.7-0.2h-0.7v-1H200.3z M199.5,218.1
h-2.2v9.2h2.2c1.3,0,2.3-0.4,2.9-1.1c0.6-0.7,0.9-1.9,0.9-3.6c0-1.6-0.3-2.8-0.9-3.5C201.8,218.4,200.8,218.1,199.5,218.1"/></svg></div>
        <div class="nav-click"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path fill="currentColor" d="M70.4,41.5c0-0.1,0-0.1-0.1-0.1c0,0-0.1,0-0.1,0c-2,0.2-6,0.7-10.2,1.8c-0.6,0.2-1.1,0.3-1.7,0.5
...
C57.9,89.7,53.8,90.3,49.6,90.3z"/></g></svg></div>
        <div class="navigation"><span></span>
            <nav class="main-menu">
                <ul>
                    <li class="nav-item"><a class="link-home link-load nav-item-a" href="https://sengroup.vn/" data-name="home-page" aria-label="nav">Trang chủ</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/home-page.html" data-hrefvi="https://sengroup.vn/trang-chu.html"
                            data-title="Trang chủ" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item current"><a class="link-load nav-item-a" href="https://sengroup.vn/gioi-thieu.html" data-name="about-page" aria-label="nav">Giới thiệu</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/about-us.html" data-hrefvi="https://sengroup.vn/gioi-thieu.html"
                            data-title="Giới thiệu" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="https://sengroup.vn/linh-vuc-hoat-dong.html" data-name="business-page" aria-label="nav">Lĩnh vực hoạt động</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/business-sector.html"
                            data-hrefvi="https://sengroup.vn/linh-vuc-hoat-dong.html" data-title="Lĩnh vực hoạt động" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="https://sengroup.vn/cong-ty-thanh-vien.html" data-name="project-page" aria-label="nav">Công ty thành viên</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/members.html"
                            data-hrefvi="https://sengroup.vn/cong-ty-thanh-vien.html" data-title="Công ty thành viên" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="https://sengroup.vn/hoat-dong-tieu-bieu.html" data-name="activities-page" aria-label="nav">Hoạt động tiêu biểu</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/activities.html"
                            data-hrefvi="https://sengroup.vn/hoat-dong-tieu-bieu.html" data-title="Hoạt động tiêu biểu" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="https://sengroup.vn/phat-trien-nguon-nhan-luc.html" data-name="recruitment-page" aria-label="nav">Phát triển nguồn nhân lực</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/recruitment.html"
                            data-hrefvi="https://sengroup.vn/phat-trien-nguon-nhan-luc.html" data-title="Phát triển nguồn nhân lực" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="https://sengroup.vn/truyen-thong.html" data-name="news-page" aria-label="nav">Truyền thông</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/media.html" data-hrefvi="https://sengroup.vn/truyen-thong.html"
                            data-title="Truyền thông" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                    <li class="nav-item"><a class="link-load nav-item-a" href="https://sengroup.vn/lien-he.html" data-name="contact-page" aria-label="nav">Liên hệ</a>
                        <div class="class-hidden link-change-url" data-hrefen="https://sengroup.vn/contact-us.html" data-hrefvi="https://sengroup.vn/lien-he.html"
                            data-title="Liên hệ" data-description="SEN GROUP" data-keyword="SEN GROUP" aria-label="link-change-url"></div>
                    </li>
                </ul>
            </nav>
            <div class="overlay-menu"></div>
            <div class="close-menu"><svg><use xlink:href="#ico-close-menu"></use></svg> <span class="line-toggle toggle-1"></span> <span class="line-toggle toggle-2"></span></div>
        </div>
        <div class="right-header">
            <div class="search-top"><button class="search-but" aria-label="search"><svg><use xlink:href="#ico-search"></use></svg> Search </button></div>
            <div class="language">
                <form id="change_lang" enctype="multipart/form-data" method="post" onsubmit="return false;">
                    <ul>
                        <li class="active"><button class="vi" aria-label="vi" onclick="onClick('vi','https://sengroup.vn/gioi-thieu.html');">tiếng việt</button></li>
                        <li><button class="en" aria-label="en" onclick="onClick('en','https://sengroup.vn/about-us.html');">english</button></li>
                    </ul><input type="hidden" value="" name="language_code" id="language_code" aria-label="input"> <input id="changlanguage_redirect" type="hidden" value="https://sengroup.vn/gioi-thieu.html" name="redirect" aria-label="input"></form>
            </div>
        </div>
        <div class="social">
            <ul>
                <li><a class="facebook" href="https://www.facebook.com/SenGroup.vn" target="_blank" rel="noopener" aria-label="Facebook">Facebook</a></li>
                <li><a class="youtube" href="https://www.youtube.com/channel/UCImEWP7omdaGVCeN_T5G57A" target="_blank" rel="noopener" aria-label="Youtube">Youtube</a></li>
            </ul>
        </div>
    </header>
    <div class="header-widget"> <a class="news-regis news-hotline" href="tel:0932929496" aria-label="news-register"><span class="icon-news-regis"><svg><use xlink:href="#ico-phone"></use></svg> </span><span class="text-news-regis">0932 92 94 96</span></a> <button class="news-regis load-subscribe"
            aria-label="news-register"><span class="icon-news-regis"><svg><use xlink:href="#ico-register"></use></svg> </span><span class="text-news-regis">Đăng ký nhận tin</span></button> </div>
    <main class="main">
        <div class="smooth-scroll">
            <div class="container" id="about-page">
                ...
                <section class="banner-inner">
                    ...
                    <div class="bg-inner"><img src="https://sengroup.vn/pictures/mobile/catalog/banner/small-1.jpg" data-src="https://sengroup.vn/pictures/catalog/banner/small-1.jpg" alt="Giới thiệu" class="lazy"></div>
                ...
                <section class="about-intro">
                    ...
                    <div class="scroll-text font-accent trans-x" data-speed="4"><span>SEN GROUP SEN GROUP SEN GROUP SEN GROUP</span> <span>SEN GROUP SEN GROUP SEN GROUP SEN GROUP</span></div>
                </section>
                <section class="about-value">
                    <div class="bg-cover"><img class="trans-y lazy" data-speed="-2" src="https://sengroup.vn/pictures/mobile/catalog/about/about-value.jpg" data-src="https://sengroup.vn/pictures/catalog/about/about-value.jpg" alt="Giá trị cốt lõi"></div>
                    <div class="wrap-content">
                ...
                <section class="about-value">
                    <div class="wrap-content">
                        <div class="title-main text-center color-blue title-underline bold-medium">
                            <h2 class="text-ani-item">CƠ CẤU TỔ CHỨC</h2>
                        </div>
                        <div class="wrap-chart">
                            <div class="chart-box ani-item">
                                <div class="pic-chart zoom-pic pic-background"><img src="https://sengroup.vn/pictures/catalog/about/co%20cau%20to%20chuc%20sen%20group.jpg" data-src="https://sengroup.vn/pictures/catalog/about/co%20cau%20to%20chuc%20sen%20group.jpg" alt="CƠ CẤU TỔ CHỨC" class="lazy"></div>
                            </div>
                        </div>
                    </div><span class="line-bottom ani-item"></span></section>
                                ...
                                <div class="slidebox-list">
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/GT4.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/GT4.jpg" alt="TẬP ĐOÀN SEN GROUP ĐÃ HỖ TRỢ 20.000 KHẨU TRANG Y TẾ CHO CÔNG TÁC PHÒNG CHỐNG DỊCH BỆNH COVID-19"
                                                    class="lazy"></div>
                                    ...
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/GT3.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/GT3.jpg" alt="ĐỐI TÁC PHÂN PHỐI CHÍNH THỨC SIÊU TỔ HỢP GIẢI TRÍ - NGHỈ DƯỠNG - ĐẦU TƯ HON THOM PARADISE ISLAND"
                                                    class="lazy"></div>
                                            <div class="text-achievement">
                                                <h3>ĐỐI TÁC PHÂN PHỐI CHÍNH THỨC SIÊU TỔ HỢP GIẢI TRÍ - NGHỈ DƯỠNG - ĐẦU TƯ HON THOM PARADISE ISLAND</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/gt2.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/gt2.jpg" alt="TẬP ĐOÀN SEN GROUP ĐÃ TẶNG 27 TỦ SÁCH NHÂN ÁI CHO 27 ĐƠN VỊ TRƯỜNG HỌC THUỘC HUYỆN PHÚ QUỐC, TỈNH KIÊN GIANG."
                                                    class="lazy"></div>
                                            <div class="text-achievement">
                                                <h3>TẬP ĐOÀN SEN GROUP ĐÃ TẶNG 27 TỦ SÁCH NHÂN ÁI CHO 27 ĐƠN VỊ TRƯỜNG HỌC THUỘC HUYỆN PHÚ QUỐC, TỈNH KIÊN GIANG.</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/gt1.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/gt1.jpg" alt="TOP 30 SÀN GIAO DỊCH BĐS TIÊU BIỂU VIỆT NAM NĂM 2017"
                                                    class="lazy"></div>
                                            <div class="text-achievement">
                                                <h3>TOP 30 SÀN GIAO DỊCH BĐS TIÊU BIỂU VIỆT NAM NĂM 2017</h3>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/GT5.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/GT5.jpg" alt="SÀN GIAO DỊCH BẤT ĐỘNG SẢN TIÊU BIỂU TOP 30 NĂM 2017"
                                                    class="lazy"></div>
                                            <div class="text-achievement">
                                    ...
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/GT6.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/GT6.jpg" alt="TẬP ĐOÀN SEN GROUP ĐÃ TÍCH CỰC THAM GIA ĐÓNG GÓP 10.000 KHẨU TRANG ỦNG HỘ PHÒNG, CHỐNG DỊCH COVID-19"
                                                    class="lazy"></div>
                                            <div class="text-achievement">
                                    ...
                                    <div class="box-achievement slidebox-item">
                                        <div class="wrap-box-achieve">
                                            <div class="pic-achievement zoom-pic zoom-hover"><img src="https://sengroup.vn/pictures/mobile/catalog/about/giai-thuong/GT7.jpg" data-src="https://sengroup.vn/pictures/catalog/about/giai-thuong/GT7.jpg" alt="TẬP ĐOÀN SEN GROUP ĐÃ TRAO TẶNG SÁCH CHO THƯ VIỆN TỈNH KIÊN GIANG"
                                                    class="lazy"></div>
                                            <div class="text-achievement">
                ...
                <footer class="footer">
                    ...
                    <div class="box-footer">
                        <div class="go-top"><svg><use xlink:href="#ico-go-top"></use></svg></div>
                        <div class="wrap-box-footer">
                            <div class="company-text">
                                ...
                                <div class="company-info ani-item">
                                    ...
                                    <ul>
                                        <li class="company-address"><span class="address"><svg><use xlink:href="#ico-company-address"></use></svg></span>
                                        ...
                                        <li><span class="call"><svg><use xlink:href="#ico-phone"></use></svg></span>
                                            <p><a href="tel:028-7305-6839">(028) 7305 6839</a> - <a href="tel:0932-92-94-96">0932 92 94 96</a></p>
                                        </li>
                                        <li><span class="email"><svg><use xlink:href="#ico-email"></use></svg></span>
                            ...
                            <div class="subscribe subscribe-footer ani-item">
                                ...
                                <form onsubmit="return false;" id="subscribe" name="subscribe" method="post">
                                    <div class="input-text"><span class="holder">Email</span><input type="text" data-default="Email" value="" id="emailsubscribe" name="emailsubscribe" data-error="Email không hợp lệ!" aria-label="Email"> <button class="sub-but" type="button"
                                            aria-label="send" id="btn-subscribe-submit" data-page="https://sengroup.vn/thank-you-.html">Gửi</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
                    <div class="bottom">
                        <div class="left-footer">
                            <div class="copyright footer-copyright detect-copry name-of-copyright footer-strong footer-company-strong footer-company-copyright color-white a-w a-s x-y z-y abc-c h-eck d-fl q-u r-t s-e i-o">
                                <p>2024 © <strong>SEN GROUP</strong>. <span>All Rights Reserved.</span></p><a href="https://www.btq.vn" target="_blank" rel="noreferrer">DEVELOPED BY 3GRAPHIC</a></div>
                        </div>
                    </div>
                </footer>
            </div>
    ...
    <div class="register"><span></span> <button class="close-regis close-format" aria-label="close"><svg><use xlink:href="#ico-close-menu"></use></svg> <span class="line-toggle toggle-1"></span> <span class="line-toggle toggle-2"></span></button>
            ...
            <div class="wrap-register-form">
                <form id="register" name="register" method="post" onsubmit="return false;">
                    <div class="require-col color-blue">
                        ...
                        <div
                            class="wrap-view-details big-view"><button class="view-details dark" aria-label="submit" id="btn-register-submit" data-page="https://sengroup.vn/thank-you-.html"><span class="small-logo-ico"><svg><use xlink:href="#ico-view-details-logo"></use></svg> <span class="rotate-logo"><svg><use xlink:href="#ico-view-details-rotate-send"></use></svg> </span></span> GỬI <svg class="viewdetails-svg"><use xlink:href="#arrow"></use></svg></button></div>
            </div>
            </form>
        </div>
        <div class="regis-info color-white">
            ...
            <ul class="company-regis-info">
                ...
                <li><span class="address"><svg><use xlink:href="#ico-company-address"></use></svg></span>
                    <p><a href="https://www.google.com/maps/place/11+%C4%90.+Nguy%E1%BB%85n+C%C3%B4ng+Tr%E1%BB%A9,+Ph%C6%B0%E1%BB%9Dng+Nguy%E1%BB%85n+Th%C3%A1i+B%C3%ACnh,+Qu%E1%BA%ADn+1,+Th%C3%A0nh+ph%E1%BB%91+H%E1%BB%93+Ch%C3%AD+Minh,+Vi%E1%BB%87t+Nam/@10.7700544,106.7018674,17z/data=!3m1!4b1!4m6!3m5!1s0x31752f4174c47f21:0x184d28bc63cf70ea!8m2!3d10.7700544!4d106.7044423!16s%2Fg%2F11bw3y54pl?entry=ttu"
                            target="_blank" rel="noopener">11 Nguyễn Công Trứ, Phường Nguyễn Thái Bình, Quận 1, TP. HCM</a></p>
                </li>
            </ul>
            <div class="social-regis">
                <ul>
                    <li><a class="facebook" href="https://www.facebook.com/SenGroup.vn" target="_blank" rel="noopener" aria-label="facebook"><svg><use xlink:href="#ico-facebook"></use></svg></a></li>
                    <li><a class="youtube" href="https://www.youtube.com/channel/UCImEWP7omdaGVCeN_T5G57A" target="_blank" rel="noopener" aria-label="youtube"><svg><use xlink:href="#ico-youtube"></use></svg></a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="cursor">
        <div class="cursor-bg"><svg><use xlink:href="#ico-loading-logo"></use></svg> <span class="circle-rotate-cursor"><svg><use xlink:href="#ico-view-details-rotate"></use></svg></span></div>
    </div>
...
c3.7-3.7,9.6-3.7,13.3,0s3.7,9.5,0,13.2s-9.6,3.7-13.3,0S13.4,19,17.1,15.5z"/></svg></div>
                    <div class="input-text"><span class="holder">Tìm kiếm ...</span><input type="text" id="quicksearch" name="quicksearch" data-default="Tìm kiếm ..." value="" aria-label="field-search">
                        ...
                        </div><button class="display-none link-search-load-typing" data-href="https://sengroup.vn/tim-kiem.html" aria-label="search"></button></div>
                    <div class="close-search"></div><input type="hidden" id="defaultvalue" name="defaultvalue" value="Tìm kiếm ..." aria-label="default value"> <input type="hidden" id="errorsearchcode" name="errorsearch" value="Từ khóa không được dưới 3 kí tự, vui lòng nhập lại từ khóa tìm kiếm!"
                        aria-label="errorsearch"> <input type="hidden" id="href_search" name="href_search" value="https://sengroup.vn/tim-kiem.html" aria-label="href search"></form>
            </div>
        </div>
    ...
    <div class="httpserver class-hidden">https://sengroup.vn/</div>
    <div class="httptemplate class-hidden">https://sengroup.vn/catalog/view/</div>
    <script type="text/javascript" src="https://sengroup.vn/catalog/view/js/gsap.js"></script>
    <script src="https://sengroup.vn/catalog/view/js/app.js?ver=1.0.8" type="text/javascript"></script>